...
[[ -d ~/go/pkg/mod ]] && rm -rf ~/go/pkg/mod/* && echo "  ✔ Go module cache cleaned"
[[ -d ~/.cache/pip ]] && rm -rf ~/.cache/pip && echo "  ✔ pip cache cleaned"
[[ -d ~/.npm/_cacache ]] && rm -rf ~/.npm/_cacache/* && echo "  ✔ npm cache cleared"
[[ -d ~/.cargo/registry/cache ]] && rm -rf ~/.cargo/registry/cache/* && echo "  ✔ Cargo registry cache cleaned"
